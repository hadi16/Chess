 ...
 * 
 * This class holds the commands to draw queens.
 * 
 * @author Alex Hadi
 * @version May 5, 2017
 */
public class Queen extends Piece {
	 ...
	 */
	public Queen(int xPos, int yPos, int player, int scaleDim) {
		super(xPos, yPos, player, scaleDim);
	}

	/**
	 * When executed, this method draws the queen based on the value of
	 * pieceHeight.
	 */
