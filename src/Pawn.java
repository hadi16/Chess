 ...
 * 
 * This class holds the commands to draw pawns.
 * 
 * @author Alex Hadi
 * @version May 5, 2017
 */
public class Pawn extends Piece {
	 ...
	 */
	public Pawn(int xPos, int yPos, int player, int scaleDim) {
		super(xPos, yPos, player, scaleDim);
	}

	/**
	 * When executed, this method draws the pawn based on the value of
	 * pieceHeight.
	 */
