 ...
 * 
 * This class holds the commands to draw knights.
 * 
 * @author Alex Hadi
 * @version May 5, 2017
 */
public class Knight extends Piece {
	 ...
	 */
	public Knight(int xPos, int yPos, int player, int scaleDim) {
		super(xPos, yPos, player, scaleDim);
	}

	/**
	 * When executed, this method draws the knight based on the value of
	 * pieceHeight.
	 */
