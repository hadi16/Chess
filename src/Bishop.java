 ...
 * 
 * This class holds the commands to draw bishops.
 * 
 * @author Alex Hadi
 * @version May 5, 2017
 */
public class Bishop extends Piece {
	 ...
	 */
	public Bishop(int xPos, int yPos, int player, int scaleDim) {
		super(xPos, yPos, player, scaleDim);
	}

	/**
	 * When executed, this method draws the bishop based on the value of
	 * pieceHeight.
	 */
